...
Route::get('/posts', [postController::class, 'index']) -> name(name: 'posts.index');  //i can neglect the argument's name and it will work well

//create is getting data from user
Route::get('/posts/create', [postController::class, 'create']) -> name(name: 'posts.create');  //it's a shortcut for the create page's path, it's usefull if i changed the path, i will not need to change it in every ancor link in the other pages
